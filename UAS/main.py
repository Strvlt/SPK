...
class BaseMethod():
    ...
    def __init__(self):
        self.raw_weight = {'harga': 8, 'ram': 5, 'kapasitas_baterai': 4, 'processor': 7, 'penyimpanan_internal': 6}
    ...
    @property
    def data(self):
        query = select(handphoneModel.iphone, handphoneModel.harga, handphoneModel.ram, handphoneModel.kapasitas_baterai, handphoneModel.processor, handphoneModel.penyimpanan_internal)
        result = session.execute(query).fetchall()
        print(result)
        return [{'iphone': handphone.iphone, 'harga': handphone.harga, 'ram': handphone.ram, 'kapasitas_baterai': handphone.kapasitas_baterai, 'processor': handphone.processor, 'penyimpanan_internal': handphone.penyimpanan_internal} for handphone in result]
...
class handphone(Resource):
    ...
    def get(self):
        ...
        data = [{'iphone': handphone.iphone, 'harga': handphone.harga, 'ram': handphone.ram, 'kapasitas_baterai': handphone.kapasitas_baterai, 'processor': handphone.processor, 'penyimpanan_internal': handphone.penyimpanan_internal} for handphone in session.scalars(query)]
